export image_name := env("IMAGE_NAME", "billet")
...
# Build the nvidia variant using the specified parameters
build-nvidia $target_image=image_name $tag="nvidia":
    #!/usr/bin/env bash

    BUILD_ARGS=()
    BUILD_ARGS+=("--build-arg" "BASE_IMAGE=fedora-bootc:42")
