...
A Universal Blue bootc image template that builds an OCI image and bootable disk images (ISO, qcow2, raw). Based on [Bluefin](https://projectbluefin.io/), it provides a refined desktop experience with the [Noctalia shell](https://noctalia.dev), [Nyxt](https://nyxt.atlascode.dev) browser, and the "Eldritch" dark theme.
